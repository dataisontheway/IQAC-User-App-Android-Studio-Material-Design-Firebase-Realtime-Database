...
import info.androidhive.navigationdrawer.other.PrivacyRecyclerViewAdapter;
...
public class SundayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(SundayActivity.this));

        // Assign activity this to progress dialog.
        progressDialog = new ProgressDialog(SundayActivity.this);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("events/sunday/sno");
