...
public class TuesdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(TuesdayActivity.this));

        // Assign activity this to progress dialog.
        progressDialog = new ProgressDialog(TuesdayActivity.this);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("events/tuesday/sno");
