...
public class WednesdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(WednesdayActivity.this));

        // Assign activity this to progress dialog.
        progressDialog = new ProgressDialog(WednesdayActivity.this);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("events/wednesday/sno");
