...
public class ThursdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ThursdayActivity.this));

        // Assign activity this to progress dialog.
        progressDialog = new ProgressDialog(ThursdayActivity.this);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("events/thursday/sno");
