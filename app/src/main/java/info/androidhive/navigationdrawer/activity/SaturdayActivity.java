...
public class SaturdayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(SaturdayActivity.this));

        // Assign activity this to progress dialog.
        progressDialog = new ProgressDialog(SaturdayActivity.this);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("events/saturday/sno");
